...
print("Привет! Это CleykaCore v.0.1.0 beta 2!")
print("")
print("Список команд:")
...
print("cd <папка> / cd .. - переход в папку (.. - предыдущая папка)")
print("ls - показывает файлы и папки в текущей директории")
print("pwd - показывает полный путь к текущей папке")
print("cat <файл> - выводит содержимое файла")
print("touch <название файла> - создает пустой файл")
print("write <файл> <содержимое> - перезаписать файл")
print("rm <папка или файл> - удаляет папку")
print("mkdir <название папки> - создает новую папку")
print("")
...
TRANSLATIONS_DB = {
    ...
    "usage_cat": {"rus": "Использование: cat <имя_файла>", "eng": "Usage: cat <filename>"},
    "usage_touch": {"rus": "Использование: touch <имя_файла>", "eng": "Usage: touch <filename>"},
